...
//   // Create a link to the superhero's details page
//   const heroLink = document.createElement("a");
//   heroLink.textContent = superhero.name;
//   heroLink.href = `herodetails.html?id=${superhero.id}`;
...
//   // Filter out the superhero to remove
//   const updatedFavorites = favorites.filter(
//     (superhero) => superhero.id !== superheroToRemove.id
//   );

//   // Update browser storage with the updated favorites list
